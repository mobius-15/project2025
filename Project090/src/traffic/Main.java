...
//		System.out.println(jet1.base1.name+"を発艦");
		...
		System.out.println("機体と兵装の重量は"+(jet1.fullWeight(weapon1,weapon2))+"lb");
		//{5,15,85,85,85,85,35,10,100,85,85,85,20};
		int[]WP=jet1.fly(13);	
		for(int wp:WP){count++;System.out.print("第"+count+"WP"+wp+"nm ");System.out.println("方位を入力");
		wd=new Scanner(System.in).nextInt();System.out.println(wp+"nm,"+wd+",");}
		System.out.println("\n");
...
//		Jet[]wphading=new Jet[13];
		...
		System.out.println("機体と兵装の重量は\""+(jet2.fullWeight(weapon1,weapon2))+"lb");
		
		WP=jet2.fly(13);
		count=0;
		for(int wp2:WP){count++;System.out.print("第"+count+"WP"+wp2+"nm ");System.out.println("方位を入力");
		wd=new Scanner(System.in).nextInt();System.out.println(wp2+"nm,"+wd+",");}
