...
public class MinatoIndex extends HttpServlet {
	...
	request.setCharacterEncoding("UTF-8");	//リクエストパラメータの取得
	String action=request.getParameter("action");
				//サイトの評価処理(初回リクエスト時はnullなので実行しない)	
	...
	RequestDispatcher dispatcher			//minatoIndex.jspにフォワード 
