...
//        ResultSet rs = null;
//        int generatedId = 0; //
//        String seqSql = "SELECT CUSTOMER_SEQ.NEXTVAL FROM DUAL";
        String strSql = "INSERT INTO CUSTOMER (ID, NAME, ZIP, ADDRESS1, ADDRESS2, TEL, FAX, EMAIL) VALUES (SEQUENCE_CUSTOMER_ID.NEXTVAL, ?, ?, ?, ?, ?, ?, ?)";
        try {
            open();
            // データベースへの接続を取得
...
//                LogUtil.printStackTrace(rollbackEx);
//            }
...
//        } return null;
    ...
    public String update(CustomerBean customer) {
      ...
      String errMessage = null;
      PreparedStatement pstmt = null;
      String strSql = "UPDATE CUSTOMER SET ID=?,NAME=?, ZIP=?, ADDRESS1=?, ADDRESS2=?, TEL=?, FAX=?, EMAIL=? WHERE id=?";
